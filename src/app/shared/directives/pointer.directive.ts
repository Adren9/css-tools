import { Directive, Input, OnInit, Output, HostListener, EventEmitter, ElementRef, Renderer2, OnChanges } from '@angular/core';
...
export class PointerDirective implements OnInit, OnChanges {
  ...
  // Change pointer position on container click if true
  @Input() allowContainerClick = true;
  ...
  ngOnInit() {
    ...
    if (this.allowContainerClick) {
      ...
      this.renderer.listen(this.pointer.nativeElement, 'mousedown', this.onPointerMouseDown.bind(this));
      this.renderer.listen(this.pointer.nativeElement, 'touchstart', this.onTouchStart.bind(this));
    }
  }
  ...
  onPointerMouseDown(e: MouseEvent) {
    this.dragStart(e);
  }

  onPointerTouchStart(e: TouchEvent) {
    this.dragStart(e);
  }
